...
if ($brandsPost != "" && !empty($brandsPost)) {
    foreach ($brandsPost as $brand) {
        if ($brand == 'innova') {
            ...
            $brandTitle = 'Other Brand';
        }
        print_r("<button id='brandsButton' style='font-size:1em;' onclick='unCheck(`". $brand ."`)'><span>". $brandTitle ."&nbsp;<i class='fa fa-close'></i></span></button>");
    }
...
if ($pricePost[0] != "1" || $pricePost[1] != "200") {
    print_r("<button id='newUsedButton' style='font-size:1em;' onclick='unSliderPrice()'><span>$". $pricePost[0] ."&nbsp;-&nbsp;$" . $pricePost[1] . "&nbsp;<i class='fa fa-close'></i></span></button>");
}

if ($weightPost[0] != "130" || $weightPost[1] != "200") {
    print_r("<button id='newUsedButton' style='font-size:1em;' onclick='unSliderWeight()'><span>". $weightPost[0] ."g&nbsp;-&nbsp;" . $weightPost[1] . "g&nbsp;<i class='fa fa-close'></i></span></button>");
}

if ($qualityPost[0] != "1" || $qualityPost[1] != "10") {
    print_r("<button id='newUsedButton' style='font-size:1em;' onclick='unSliderQuality()'><span>". $qualityPost[0] ."/10&nbsp;-&nbsp;" . $qualityPost[1] . "/10&nbsp;<i class='fa fa-close'></i></span></button>");
}
