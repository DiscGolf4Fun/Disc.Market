			...
			<section id="footer" class="container">
				<div class="row">
					...
					<div class="4u 12u(mobile)" align="center">
						<section>
							...
							<ul class="social">
								<li>
									<a class="icon fa-facebook" href="http://www.facebook.com" target="_blank">
										<span class="label">Facebook</span>
									</a>
								</li>
								<li>
									<a class="icon fa-twitter" href="http://www.twitter.com" target="_blank">
				...
				<div class="row">
					<div class="12u">
						...
						<div id="copyright">
							<ul class="links">
								<li>&copy; Disc Market. All rights reserved.</li>
							</ul>
						</div>
